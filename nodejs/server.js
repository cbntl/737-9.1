...
// const uri = 'mongodb+srv://admin:<password>@cluster0.dbnau.mongodb.net/'; 
const uri = 'mongodb+srv://admin:52802utQTTngSBxV@cluster0.dbnau.mongodb.net/?authMechanism=SCRAM-SHA-1'; 
MongoClient.connect(uri, (err, client) => {
	if (err) return console.log(err);
	db = client.db('sit737data');
